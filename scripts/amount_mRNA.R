...
folder <- "/data/home/students/ciora/methods/salmon/output/"
samples <- c("SRR5144100", "SRR5144101", "SRR5144102", "SRR5144103", "SRR5144104", "SRR5144105", "SRR5144106", "SRR5144107", "SRR5144108", "SRR5144109", "SRR5144110", "SRR5144111", "SRR5144112", "SRR5144113", "SRR5144115", "SRR5144116", "SRR5144117", "SRR5144118", "SRR5144119", "SRR5144120", "SRR5144121", "SRR5144123", "SRR5144124")
finaldata <- NULL
readNumber <- NULL
unnorm_counts <- NULL
...
readNumber <- data.frame(readNumber)
#write.table(finaldata, "/data/home/students/ciora/methods/salmon/mRNA_results.tsv", quote = F, sep = "\t", row.names = F)
write.table(unnorm_counts, "/data/home/students/ciora/methods/salmon/mRNA_unnormalized.tsv", quote = F, sep = "\t", row.names = F)
exprs <- unnorm_counts[,-1]
f_data <- data.frame(unnorm_counts[,1])
f_data$t <- unnorm_counts[,1]
write.table(f_data, "/data/home/students/ciora/methods/diffExp/f_data.txt", quote = F, sep = "\t", row.names = F, col.names = F)
write.table(exprs, "/data/home/students/ciora/methods/diffExp/exprs.txt", quote = F, sep = "\t", row.names = F, col.names = F)
...
ggsave("/data/home/students/ciora/circRNA-detection/plots/read_distribution_mRNA.png", width = 6, height = 4)
dev.off()