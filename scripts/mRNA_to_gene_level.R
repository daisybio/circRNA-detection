...
dir <- "/data/home/students/ciora/methods/salmon/output"
...
names(txi)
write.table(txi$counts, "/data/home/students/ciora/methods/salmon/genelevel_counts.tsv", quote = F, sep = "\t", row.names = T)
